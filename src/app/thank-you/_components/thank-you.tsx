...
export const ThankYouComponent = () => {
  ...
  return (
    <div className="bg-white">
      <div className="mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 max-w-3xl">
        <div className="max-w-xl">
          <p className="font-medium text-base text-primary">Thank you!</p>
          <h1 className="mt-2 font-bold text-4xl sm:text-5xl tracking-tight">
        ...
        <div className="border-zinc-200 mt-10 border-t">
        ...
        <div className="flex space-x-6 bg-gray-900/5 mt-4 rounded-xl lg:rounded-2xl overflow-hidden ring-1 ring-gray-900/10 ring-inset">
          <PhonePreview
        ...
        <div>
          ...
          <div className="gap-x-6 border-zinc-200 grid grid-cols-2 py-10 border-t text-sm">
            <div>
        ...
        <div className="space-y-6 border-zinc-200 pt-10 border-t text-sm">
